...
const { AM_S19XP } = require('../../../workers/miners/antminer')

// Container type
const { AS_HK3 } = require('../../../workers/containers/antspace')

// Power meter
const { ABB_B23 } = require('../../../workers/power-meter/abb')

// Temperature sensor
const { SENECA } = require('../../../workers/temperature')

// Mock hardware servers
const wmMock = require('../../../workers/miners/whatsminer/mock/server')
const amMock = require('../../../workers/miners/antminer/mock/server')
const asMock = require('../../../workers/containers/antspace/mock/server')
const abbMock = require('../../../workers/power-meter/abb/mock/server')
const senMock = require('../../../workers/temperature/mock/server')

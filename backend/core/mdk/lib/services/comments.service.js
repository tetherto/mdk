...
/**
 * Comments live on the persisted device record (`comments` array). The
 * storage collaborators are injected — wire them to a
 * DeviceProvisioningService (loadThing/saveThing/checkThingExists/generateId).
 */

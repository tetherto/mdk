  ...
  <section className="demo-section">
    ...
    <section>
      <Accordion isOpened title="Basic Opened Accordion">
        This is a basic opened accordion. You can put any content here, such as text, lists, or even
        other components.
      </Accordion>
    </section>
      ...
      <Accordion title="Multiple Accordion">
        <AccordionItem value="faq-1">
          ...
          <AccordionContent>
            ...
            problems that verify transactions in the currency. When a bitcoin is successfully mined,
        ...
        <AccordionItem value="faq-3">
          ...
          <AccordionContent>
            Initial costs vary widely depending on the scale of your operation. A single ASIC miner
            can cost between $2,000 to $10,000+, plus ongoing electricity costs which can be
            substantial.
          </AccordionContent>
        </AccordionItem>
      </Accordion>

...
export const ListViewFilterExample = (): JSX.Element => {
   ...
   */
  const handleFilterChange = useCallback((selections: Array<Array<string | number | boolean>>) => {
                ...
                <Card key={device.id}>
                  ...
                  <CardBody>
                    ...
                    <div className="list-view-filter-example__card-metrics">
                      <div>
                        ...
                        <span>
                          {device.hashrate > 0
                            ? `${device.hashrate} ${UNITS.HASHRATE_TH_S}`
                            : 'N/A'}
                        </span>
                      </div>
                      ...
                      <div>
                        ...
                        <span>
                          {device.temperature > 0
                            ? `${device.temperature}${UNITS.TEMPERATURE_C}`
                            : 'N/A'}
                        </span>
                      </div>
                    </div>
                  ...
                  <CardFooter className="list-view-filter-example__card-footer">
                    ...
                    <Typography variant="body" weight="medium" color="primary">
                      {device.power > 0 ? `${device.power}${UNITS.POWER_W}` : 'N/A'}
                    </Typography>
                  </CardFooter>
                </Card>
              ))}

...
import { BitMainImmersionSummaryBox } from '@tetherto/mdk-react-devkit/domain'
...
export const BitMainImmersionSummaryBoxPage = (): JSX.Element => (
  <section className="demo-section">
    ...
    >
      ...
      <section>
        <h3>
          Missing liquid temperature fields (matches app: empty values, not 0{UNITS.TEMPERATURE_C})
        </h3>

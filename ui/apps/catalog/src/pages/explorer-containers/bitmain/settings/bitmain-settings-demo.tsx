      ...
      <div className="bitmain-hydro-demo__controls">
        <div className="bitmain-hydro-demo__presets">
          ...
          <div className="bitmain-hydro-demo__preset-buttons">
            {(Object.keys(DEMO_PRESETS) as PresetKey[]).map((key) => (
              ...
              >
                {key === 'normal' && `Normal (35${UNITS.TEMPERATURE_C}, 2.5 ${UNITS.PRESSURE_BAR})`}
                {key === 'highTemp' &&
                  `High Temp (42${UNITS.TEMPERATURE_C}, 3.8 ${UNITS.PRESSURE_BAR})`}
                {key === 'withFaults' &&
                  `With Faults (38${UNITS.TEMPERATURE_C}, 1.8 ${UNITS.PRESSURE_BAR})`}
                {key === 'lowTemp' &&
                  `Low Temp (18${UNITS.TEMPERATURE_C}, 1.5 ${UNITS.PRESSURE_BAR})`}
              </Button>
            ))}
          </div>
        </div>
        ...
        <div className="bitmain-hydro-demo__custom">
          ...
          <div className="bitmain-hydro-demo__custom-grid">
            <Input
              label={`Water Temperature (${UNITS.TEMPERATURE_C})`}
              type="number"
              value={waterTemp}
              onChange={(e) => {
            ...
            />
            <Input
              label={`Supply Liquid Pressure (${UNITS.PRESSURE_BAR})`}
              type="number"
              value={pressure}
              onChange={(e) => {
            ...
            />
            <Input
              label={`Distribution Box #1 Power (${UNITS.POWER_W})`}
              type="number"
              value={customPower1}
              onChange={(e) => {
            ...
            />
            <Input
              label={`Distribution Box #2 Power (${UNITS.POWER_W})`}
              type="number"
              value={customPower2}
              onChange={(e) => {

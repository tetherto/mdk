 ...
 * from `@tetherto/mdk-react-devkit`'s `explorer/dialogs` barrel. Dialogs that
 * dispatch actions write into the shared Zustand `actionsStore` provided by
 * `MdkProvider` higher up the tree.
 */
...
/**
 * Wraps each dialog in a controlled-open state, exposing an `open` flag and
 * `close` callback to the render-prop child.
 */

    ...
    <div className="mosaic-demo">
      ...
      >
        ...
        <Mosaic.Item area="hashrate" className="mosaic-demo__metric-card">
          ...
          <p className="mosaic-demo__metric-value">1,540 {UNITS.HASHRATE_TH_S}</p>
          <p className="mosaic-demo__metric-change">+2.3{UNITS.PERCENT} from yesterday</p>
        </Mosaic.Item>

        <Mosaic.Item area="temperature" className="mosaic-demo__metric-card">
          <h3>Avg Temperature</h3>
          <p className="mosaic-demo__metric-value">65{UNITS.TEMPERATURE_C}</p>
          <Indicator color="green">Normal</Indicator>
        </Mosaic.Item>

        <Mosaic.Item area="power" className="mosaic-demo__metric-card">
          <h3>Power Consumption</h3>
          <Typography className="mosaic-demo__metric-value">234 {UNITS.POWER_KW}</Typography>
          <Typography size="xs" color="muted">
            $28.08/hour
          </Typography>
        </Mosaic.Item>
        ...
        <Mosaic.Item area="workers" className="mosaic-demo__metric-card">
          ...
          <ul className="mosaic-demo__workers-list">
            ...
            {[
              { name: 'Miner-001', hashrate: `10.2 ${UNITS.HASHRATE_TH_S}`, status: 'online' },
              { name: 'Miner-002', hashrate: `9.8 ${UNITS.HASHRATE_TH_S}`, status: 'online' },
              { name: 'Miner-003', hashrate: `10.5 ${UNITS.HASHRATE_TH_S}`, status: 'online' },
              { name: 'Miner-004', hashrate: `0.0 ${UNITS.HASHRATE_TH_S}`, status: 'offline' },
              { name: 'Miner-005', hashrate: `10.1 ${UNITS.HASHRATE_TH_S}`, status: 'online' },
            ].map((worker) => (
        ...
        >
          ...
          <div className="mosaic-demo__alerts-container">
            <Card className="mosaic-demo__alert-card">
              ...
              <p className="mosaic-demo__alert-description">
                Miner-012 reached 78{UNITS.TEMPERATURE_C}
              </p>
        ...
        >
          ...
          <div className="mosaic-demo__earnings-grid">
            <div className="mosaic-demo__earnings-item">
              ...
              <p className="mosaic-demo__earnings-value">{CURRENCY.USD}673.45</p>
            </div>
            <div className="mosaic-demo__earnings-item">
              <p className="mosaic-demo__earnings-label">This Week</p>
              <p className="mosaic-demo__earnings-value">{CURRENCY.USD}4,714.15</p>
            </div>
            <div className="mosaic-demo__earnings-item">
              <p className="mosaic-demo__earnings-label">This Month</p>
              <p className="mosaic-demo__earnings-value">{CURRENCY.USD}20,187.60</p>
            </div>
            <div className="mosaic-demo__earnings-item">
              <p className="mosaic-demo__earnings-label">All Time</p>
              <p className="mosaic-demo__earnings-value">{CURRENCY.USD}156,432.90</p>
            </div>
          </div>
        </Mosaic.Item>
      </Mosaic>

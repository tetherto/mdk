            ...
            <PopoverContent showClose>
              <div style={{ width: '350px' }}>
                ...
                >
                  ...
                  <div style={{ fontWeight: 500 }}>110 ${UNITS.HASHRATE_TH_S}</div>
                  <div style={{ opacity: 0.7 }}>Temperature:</div>
                  <div style={{ fontWeight: 500, color: '#72f59e' }}>65${UNITS.TEMPERATURE_C}</div>
                  <div style={{ opacity: 0.7 }}>Power:</div>
                  <div style={{ fontWeight: 500 }}>3250${UNITS.POWER_W}</div>
                  <div style={{ opacity: 0.7 }}>Efficiency:</div>
                  <div style={{ fontWeight: 500 }}>29.5 ${UNITS.EFFICIENCY_W_PER_TH}</div>

...
const LazyTab1Content = lazy<ComponentType>(() => Promise.resolve({ default: Tab1Content }))
const LazyTab2Content = lazy<ComponentType>(
  () =>
    new Promise((resolve) => {
      setTimeout(() => {
...
const LazyTab3Content = lazy<ComponentType>(
  () =>
    new Promise((resolve) => {
      setTimeout(() => {

...
const Cascader = forwardRef<HTMLDivElement, CascaderProps>(
  (
    ...
    const [selectedTags, setSelectedTags] = useState<{ label: string; id: string }[]>([])
    ...
    const highlightText = useCallback((text: string, search: string): ReactNode => {

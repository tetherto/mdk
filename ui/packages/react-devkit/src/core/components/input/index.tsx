...
/**
 * Text input with optional label, prefix/suffix slots, and a `search`
 * variant. Forwards refs and all native `<input>` attributes.
 *
 * @category forms
 * @domain generic
 * @tier agent-ready
 ...
 * @example
 * ```tsx
 * import { UNITS, CURRENCY } from '../../constants/units'
 *
 * <Input label="MAC Address" placeholder="Enter MAC address" id="mac" />
 * <Input variant="search" placeholder="Search" />
 * <Input prefix={CURRENCY.USD} suffix="USD" placeholder="0.00" />
 * <Input suffix={UNITS.TEMPERATURE_C} placeholder="Temperature" />
 * ```
 */

...
export type TagInputProps = {
   ...
   */
  renderDropdown?: (props: TagInputDropdownProps) => ReactNode
}
 ...
 * @tier agent-ready
 */
const TagInput = forwardRef<TagInputRef | HTMLInputElement, TagInputProps>(
  (
    {
      value = [],
      onTagsChange,
    ...
    const openChangeTimeoutRef = useRef<ReturnType<typeof setTimeout>>(undefined)
    ...
    const handleWrapperClick = (e: MouseEvent<HTMLDivElement>): void => {

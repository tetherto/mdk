...
import type { TimelineItemData } from '@domain/components/alarm/alarm-row/alarm-row'
import { AlarmRow } from '@domain/components/alarm/alarm-row/alarm-row'
...
vi.mock('@domain/components/alarm/alarm-row/alarm-row', () => ({

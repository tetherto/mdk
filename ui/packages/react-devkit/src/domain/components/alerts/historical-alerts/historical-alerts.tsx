...
import type { DataTableSortingState, DateRange } from '@primitives'
import { cn, DataTable, DateRangePicker } from '@primitives'
...
/**
 * Sortable data table of historical alerts within a controlled date range.
 * Renders a header with title + `DateRangePicker`, then the table.
 *
 * @category tables

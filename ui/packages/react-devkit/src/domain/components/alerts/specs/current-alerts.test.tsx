...
vi.mock('@domain/components/alerts/alerts-utils', () => ({
  getCurrentAlerts: mockGetCurrentAlerts,
}))

vi.mock('@domain/components/alerts/tag-filter-bar/tag-filter-bar', () => ({
  TagFilterBar: ({
    filterTags,
    localFilters,
    onSearchTagsChange,
...
vi.mock(
  '@domain/components/alerts/current-alerts/alert-confirmation-modal/alert-confirmation-modal',
  () => ({

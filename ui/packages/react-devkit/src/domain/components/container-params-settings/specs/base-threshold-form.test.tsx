...
import { useContainerThresholds } from '@domain/components/container/use-container-thresholds'
import { BaseThresholdForm } from '../base-threshold-form'

// Mock dependencies
vi.mock('@domain/components/container/use-container-thresholds', () => ({
...
vi.mock('@primitives/index', async () => {
  const actual = await vi.importActual('@primitives/index')
  return {
    ...actual,
...
vi.mock('@domain/components/container-params-settings/status-indicator', () => ({

...
import { BaseThresholdForm } from '@domain/components/container-params-settings/base-threshold-form'
import { EditableThresholdForm } from '../editable-threshold-form'

// Mock BaseThresholdForm
vi.mock('@domain/components/container-params-settings/base-threshold-form', () => ({

...
import { ActionButton, Button, Label, SimpleTooltip, Switch } from '@primitives'
...
export const ContainerControlsBox: FC<ContainerControlsBoxProps> = ({
  ...
  const { setResetSelections } = useDevices()
  ...
  const onResetSelections = () => setResetSelections()
  const onAddPendingSubmission = (params: unknown) =>
    setAddPendingSubmissionAction(params as Parameters<typeof setAddPendingSubmissionAction>[0])

...
import { getSwitchAllSocketsParams } from '@domain/utils/action-utils'
import { appendContainerToTag } from '@domain/utils/device-utils'
import { notifyInfo } from '@domain/utils/notification-utils'
import { getAllSelectedContainerInfo } from '@domain/components/container/helper'
...
vi.mock('@domain/constants/actions', () => ({
  ACTION_TYPES: {
...
vi.mock('@domain/constants/devices', () => ({
  CROSS_THING_TYPES: {
    MINER: 'miner',
    CONTAINER: 'container',
  },

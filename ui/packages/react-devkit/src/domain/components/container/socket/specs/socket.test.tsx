...
import { HEATMAP_MODE } from '@domain/constants/temperature-constants'
import { SOCKET_STATUSES } from '@domain/utils/status-utils'
import { Socket } from '../socket'

import { getPowerModeColor, getTemperatureColor } from '@domain/utils/device-utils'
import {
  getHeatmapDisplayValue,
  getHeatmapTooltipText,
  getSocketStatus,
} from '@domain/components/container/socket/socket-utils'
...
vi.mock('@tetherto/mdk-react-adapter', async () => {
  ...
  return {
    ...actual,
    useTimezoneFormatter: () => ({ getFormattedDate: vi.fn(() => '2024-01-01 12:00') }),
  }
})
...
vi.mock('@domain/utils/status-utils', () => ({
  SOCKET_STATUSES: {
...
vi.mock('@domain/components/container/socket/socket-utils', () => ({

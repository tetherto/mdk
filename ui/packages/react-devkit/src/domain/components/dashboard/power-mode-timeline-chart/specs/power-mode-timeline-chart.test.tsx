...
import { getPowerModeTimelineChartData } from '@domain/components/dashboard/power-mode-timeline-chart/power-mode-timeline-chart.helper'

vi.mock(
  '@domain/components/dashboard/power-mode-timeline-chart/power-mode-timeline-chart.helper',
  () => ({
...
vi.mock('@domain/components/timeline-chart', () => ({

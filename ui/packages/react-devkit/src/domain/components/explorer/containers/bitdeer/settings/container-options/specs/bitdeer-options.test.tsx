...
import { getBitdeerCoolingSystemData } from '@domain/components/explorer/containers/bitdeer/settings/bitdeer-settings-utils'
import { BitdeerOptions } from '../bitdeer-options'
import { BitdeerPumps } from '@domain/components/explorer/containers/bitdeer/settings/container-options/bitdeer-pumps'
import { DryCooler } from '@domain/components/explorer/containers/bitdeer/settings/container-options/dry-cooler/dry-cooler'

// Mock child components
vi.mock(
  '@domain/components/explorer/containers/bitdeer/settings/container-options/dry-cooler/dry-cooler',
  () => ({
...
vi.mock(
  '@domain/components/explorer/containers/bitdeer/settings/container-options/bitdeer-pumps',
  () => ({
...
// Mock utils
vi.mock('@domain/components/explorer/containers/bitdeer/settings/bitdeer-settings-utils', () => ({

import { COLOR } from '@primitives/index'
import { describe, expect, it, vi } from 'vitest'
import type * as DeviceUtils from '@domain/utils/device-utils'
import type { Container } from '@domain/types/device'
import { CONTAINER_STATUS } from '@domain/utils/status-utils'
import {

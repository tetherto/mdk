...
import { ImmersionEditableThresholdForm } from '@domain/components/container-params-settings/immersion-editable-threshold-form'
...
} from '@domain/components/explorer/containers/bitmain-immersion/bitmain-immersion-utils'

vi.mock('@domain/components/container-params-settings/immersion-editable-threshold-form', () => ({
...
vi.mock('@domain/components/explorer/containers/bitmain-immersion/bitmain-immersion-utils', () => ({

...
import { HydroEditableThresholdForm } from '@domain/components/container-params-settings/hydro-editable-threshold-form'
...
} from '@domain/components/explorer/containers/bitmain/bitmain-hydro-utils'
import { BitMainBasicSettings } from '@domain/components/explorer/containers/bitmain/status-item'

// Mock child components
vi.mock('@domain/components/explorer/containers/bitmain/status-item', () => ({
  BitMainBasicSettings: vi.fn(({ data }) => (
    <div data-testid="basic-settings">Basic Settings - {data?.id || 'no-data'}</div>
  )),
}))

vi.mock('@domain/components/container-params-settings/hydro-editable-threshold-form', () => ({
...
// Mock utils
vi.mock('@domain/components/explorer/containers/bitmain/bitmain-hydro-utils', () => ({

...
import { BitMainCoolingSystem } from '@domain/components/explorer/containers/bitmain/status-item/settings/cooling-system/bitmain-cooling-system'
import { BitMainPowerAndPositioning } from '@domain/components/explorer/containers/bitmain/status-item/settings/power-and-positioning/bitmain-power-and-positioning'

// Mock child components
vi.mock(
  '@domain/components/explorer/containers/bitmain/status-item/settings/cooling-system/bitmain-cooling-system',
  () => ({
...
vi.mock(
  '@domain/components/explorer/containers/bitmain/status-item/settings/power-and-positioning/bitmain-power-and-positioning',
  () => ({
...
describe('bitMainBasicSettings', () => {
  ...
  it('should pass data to BitMainCoolingSystem', () => {
    ...
    expect(BitMainCoolingSystem).toHaveBeenCalledWith({ data: mockDevice }, undefined)
  })

  it('should pass data to BitMainPowerAndPositioning', () => {
    render(<BitMainBasicSettings data={mockDevice} />)

    expect(BitMainPowerAndPositioning).toHaveBeenCalledWith({ data: mockDevice }, undefined)
  })

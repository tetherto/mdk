...
import { MicroBTEditableThresholdForm } from '@domain/components/container-params-settings/micro-bt-editable-threshold-form'
import { MicroBTSettings } from '../settings/micro-bt-settings'
import * as utils from '@domain/components/explorer/containers/micro-bt/settings/micro-bt-utils'

vi.mock('@domain/components/container-params-settings', () => ({
  ContainerParamsSettings: vi.fn(() => <div data-testid="params" />),
}))

vi.mock('@domain/components/container-params-settings/micro-bt-editable-threshold-form', () => ({

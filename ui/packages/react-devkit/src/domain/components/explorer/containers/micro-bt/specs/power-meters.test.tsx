...
import { GenericDataBox } from '@domain/components/container/generic-data-box/generic-data-box'
...
vi.mock('@domain/components/container/generic-data-box/generic-data-box', () => ({

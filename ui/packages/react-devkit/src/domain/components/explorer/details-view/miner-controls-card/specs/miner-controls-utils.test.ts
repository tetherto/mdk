...
import { MINER_TYPE, MinerStatuses } from '@domain/constants/device-constants'
import { MINER_POWER_MODE } from '@domain/utils/status-utils'
import type { Device } from '@domain/types'

vi.mock('@domain/utils/containerUtils', () => ({

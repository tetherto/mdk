...
import { getCurrentPowerModes } from '@domain/components/explorer/details-view/miner-controls-card/miner-controls-utils'
...
vi.mock(
  '@domain/components/explorer/details-view/miner-power-mode-selection-buttons/power-mode-selection-dropdown',
  () => ({

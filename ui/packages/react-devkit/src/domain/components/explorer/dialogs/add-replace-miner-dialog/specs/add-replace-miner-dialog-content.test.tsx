...
import {
  buildAddReplaceMinerParams,
  isActionExists,
} from '@domain/components/explorer/dialogs/add-replace-miner-dialog/helper'
...
vi.mock('@domain/components/explorer/dialogs/add-replace-miner-dialog/helper', () => ({
...
vi.mock(
  '@domain/components/explorer/dialogs/position-change-dialog/rack-id-selection-dropdown/rack-id-selection-dropdown',
  () => ({
...
vi.mock(
  '@domain/components/explorer/dialogs/position-change-dialog/static-miner-ip-assigment/static-miner-ip-assigment',
  () => ({
...
describe('AddReplaceMinerDialogContent', () => {
  ...
  describe('successful form submission', () => {
    ...
    it('enqueues a pending submission with REGISTER_THING for add flow', async () => {
      renderComponent()
      fillValidForm()
      clickSubmit()
      await waitFor(() => {
  ...
  describe('action already exists', () => {
    it('calls notifyError and does not enqueue a submission when action already exists', async () => {

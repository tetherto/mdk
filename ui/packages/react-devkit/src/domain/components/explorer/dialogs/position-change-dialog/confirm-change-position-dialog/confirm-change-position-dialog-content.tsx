...
import { Button, createFieldNames, DialogFooter, Form, FormCheckbox } from '@primitives'
...
import type { SelectedEditSocket } from '@tetherto/mdk-react-adapter'
...
export const ConfirmChangePositionDialogContent = ({
  ...
  const onSubmit = async (values: ConfirmPositionFormValues) => {
    ...
    setAddPendingSubmissionAction(batchedAction)
    onSave()
    notifyInfo(
      'Action added',

...
import type { UnknownRecord } from '@primitives/index'
...
vi.mock('@primitives/index', async () => {
  const actual = await vi.importActual<typeof import('@primitives/index')>('@primitives/index')
  return {
    ...actual,

...
vi.mock(
  '@domain/components/explorer/dialogs/position-change-dialog/confirm-change-position-dialog/confirm-change-position-dialog-content',
  () => ({
...
vi.mock(
  '@domain/components/explorer/dialogs/position-change-dialog/container-selection-dialog-content/container-selection-dialog-content',
  () => ({
...
vi.mock(
  '@domain/components/explorer/dialogs/add-replace-miner-dialog/add-replace-miner-dialog-content',
  () => ({
...
vi.mock(
  '@domain/components/explorer/dialogs/position-change-dialog/remove-miner-dialog/remove-miner-dialog-content',
  () => ({
...
vi.mock(
  '@domain/components/explorer/dialogs/position-change-dialog/maintenance-dialog-content/maintenance-dialog-content',
  () => ({
...
vi.mock(
  '@domain/components/explorer/dialogs/position-change-dialog/default-position-change-dialog-content/default-position-change-dialog-content',
  () => ({

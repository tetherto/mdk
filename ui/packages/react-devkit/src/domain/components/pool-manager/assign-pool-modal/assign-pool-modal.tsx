 ...
 * last-updated time), an endpoints preview, and an optional credential
 * template preview. Submission is async; the modal stays open with a loading
 * state until the parent resolves.
 *
 * @category dialogs

import { ArrowIcon, cn, DropdownMenu, ExportIcon, Spinner } from '@primitives'
import type { ComponentSize, SpinnerProps } from '@primitives'
...
/**
 * Dropdown button that triggers asynchronous CSV or JSON export. Shows a
 * spinner while the corresponding handler is awaited.
 *
 * @category actions
 * @domain financial-reporting
 * @kernelCapability financial-exports
 * @tier agent-ready
 *
 * @example
 * ```tsx

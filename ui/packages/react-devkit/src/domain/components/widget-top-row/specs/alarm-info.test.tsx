...
import { SimpleTooltip } from '@primitives/index'
import type { Alert } from '@domain/types/alerts'
import { getAlertsDescription } from '@domain/utils/alerts-utils'
...
vi.mock('@domain/utils/alerts-utils', () => ({
...
describe('AlarmInfo', () => {
  ...
  describe('hooks integration', () => {
    it('calls useTimezoneFormatter hook', () => {
      render(<AlarmInfo title="Temperature" icon={mockIcon} items={mockAlerts} />)

      expect(useTimezoneFormatter).toHaveBeenCalled()
    })
    ...
    it('passes getFormattedDate to getAlertsDescription', () => {
      ...
      vi.mocked(useTimezoneFormatter).mockReturnValue({ getFormattedDate: mockGetFormattedDate })

...
export const SPARE_PART_INITIAL_LOCATION = 'Site Warehouse'

export const SPARE_PART_LOCATION_LABELS: Record<string, string> = {
  [SPARE_PART_LOCATIONS.WORKSHOP_WAREHOUSE]: 'Workshop Warehouse',
  [SPARE_PART_LOCATIONS.WORKSHOP_LAB]: 'Workshop Lab',
  [SPARE_PART_LOCATIONS.SITE_WAREHOUSE]: SPARE_PART_INITIAL_LOCATION,
  [SPARE_PART_LOCATIONS.SITE_LAB]: 'Site Lab',
  [SPARE_PART_LOCATIONS.SITE_CONTAINER]: 'Site Container',
  [SPARE_PART_LOCATIONS.DISPOSED]: 'Disposed',
  [SPARE_PART_LOCATIONS.VENDOR]: 'Vendor',
  [SPARE_PART_LOCATIONS.UNKNOWN]: 'Unknown',
}

export const getSparePartLocationLabel = (location: string): string =>
  SPARE_PART_LOCATION_LABELS[location] ?? location
...
export const SPARE_PART_STATUS_BG_COLORS = {
  ...
  [SPARE_PART_STATUSES.OK_REPAIRED]: '#73F59E33',

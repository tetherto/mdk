...
vi.mock('@/components/alerts/alerts-utils', () => ({
  getCurrentAlerts: mockGetCurrentAlerts,
}))

vi.mock('@/components/alerts/tag-filter-bar/tag-filter-bar', () => ({
  TagFilterBar: ({
    filterTags,
    localFilters,
    onSearchTagsChange,
...
vi.mock(
  '@/components/alerts/current-alerts/alert-confirmation-modal/alert-confirmation-modal',
  () => ({

...
import { useContainerThresholds } from '@/components/container/use-container-thresholds'
import { BaseThresholdForm } from '../base-threshold-form'

// Mock dependencies
vi.mock('@/components/container/use-container-thresholds', () => ({
...
vi.mock('@core/index', async () => {
  const actual = await vi.importActual('@core/index')
  return {
    ...actual,
...
vi.mock('@/components/container-params-settings/status-indicator', () => ({

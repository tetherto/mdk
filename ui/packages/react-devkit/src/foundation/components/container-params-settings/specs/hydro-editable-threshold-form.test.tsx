...
import { BaseThresholdForm } from '@/components/container-params-settings/base-threshold-form'
import { HydroEditableThresholdForm } from '../hydro-editable-threshold-form'

// Mock BaseThresholdForm
vi.mock('@/components/container-params-settings/base-threshold-form', () => ({

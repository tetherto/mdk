...
import { getButtonsStates } from '@/components/explorer/details-view/details-view-utils'
import { groupTailLogByMinersByType } from '@/components/explorer/details-view/miner-controls-card/miner-controls-utils'
import { getContainerState } from '@/components/container/helper'
import {
  resetAlarm,
  ...
  switchContainer,
  switchCoolingSystem,
} from '@/components/container/container-controls-box/container-controls-box-helpers'
...
vi.mock('@/utils/use-update-existed-actions', () => ({
...
vi.mock('@/components/explorer/details-view/details-view-utils', () => ({
...
vi.mock('@/components/container/helper', () => ({
...
vi.mock('@/components/explorer/details-view/miner-controls-card/miner-controls-utils', () => ({
  groupTailLogByMinersByType: vi.fn(() => ({ mode: 'eco' })),
}))

vi.mock(
  '@/components/explorer/details-view/miner-power-mode-selection-buttons/miner-power-mode-selection-buttons',
  () => ({
...
vi.mock('@/components/container/enabled-disable-toggle/enabled-disable-toggle', () => ({
...
vi.mock('@/components/container/system-status-control-box/system-status-control-box', () => ({
  SystemStatusControlBox: vi.fn(({ data }) => (
    <div data-testid="bitmain-immersion-status" data-id={data?.id} />
  )),
}))

vi.mock('@/components/container/container-controls-box/container-controls-box-helpers', () => ({

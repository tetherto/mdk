...
import { getPowerModeTimelineChartData } from '@/components/dashboard/power-mode-timeline-chart/power-mode-timeline-chart.helper'

vi.mock(
  '@/components/dashboard/power-mode-timeline-chart/power-mode-timeline-chart.helper',
  () => ({
...
vi.mock('@/components/timeline-chart', () => ({

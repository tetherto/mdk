...
import { getBitdeerCoolingSystemData } from '@/components/explorer/containers/bitdeer/settings/bitdeer-settings-utils'
import { BitdeerOptions } from '../bitdeer-options'
import { BitdeerPumps } from '@/components/explorer/containers/bitdeer/settings/container-options/bitdeer-pumps'
import { DryCooler } from '@/components/explorer/containers/bitdeer/settings/container-options/dry-cooler/dry-cooler'

// Mock child components
vi.mock(
  '@/components/explorer/containers/bitdeer/settings/container-options/dry-cooler/dry-cooler',
  () => ({
...
vi.mock(
  '@/components/explorer/containers/bitdeer/settings/container-options/bitdeer-pumps',
  () => ({
...
// Mock utils
vi.mock('@/components/explorer/containers/bitdeer/settings/bitdeer-settings-utils', () => ({

...
import { ImmersionEditableThresholdForm } from '@/components/container-params-settings/immersion-editable-threshold-form'
...
} from '@/components/explorer/containers/bitmain-immersion/bitmain-immersion-utils'

vi.mock('@/components/container-params-settings/immersion-editable-threshold-form', () => ({
...
vi.mock('@/components/explorer/containers/bitmain-immersion/bitmain-immersion-utils', () => ({

...
import { HydroEditableThresholdForm } from '@/components/container-params-settings/hydro-editable-threshold-form'
...
} from '@/components/explorer/containers/bitmain/bitmain-hydro-utils'
import { BitMainBasicSettings } from '@/components/explorer/containers/bitmain/status-item'

// Mock child components
vi.mock('@/components/explorer/containers/bitmain/status-item', () => ({
  BitMainBasicSettings: vi.fn(({ data }) => (
    <div data-testid="basic-settings">Basic Settings - {data?.id || 'no-data'}</div>
  )),
}))

vi.mock('@/components/container-params-settings/hydro-editable-threshold-form', () => ({
...
// Mock utils
vi.mock('@/components/explorer/containers/bitmain/bitmain-hydro-utils', () => ({

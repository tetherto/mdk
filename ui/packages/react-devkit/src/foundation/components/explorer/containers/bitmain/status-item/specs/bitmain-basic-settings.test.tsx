...
import { BitMainCoolingSystem } from '@/components/explorer/containers/bitmain/status-item/settings/cooling-system/bitmain-cooling-system'
import { BitMainPowerAndPositioning } from '@/components/explorer/containers/bitmain/status-item/settings/power-and-positioning/bitmain-power-and-positioning'

// Mock child components
vi.mock(
  '@/components/explorer/containers/bitmain/status-item/settings/cooling-system/bitmain-cooling-system',
  () => ({
...
vi.mock(
  '@/components/explorer/containers/bitmain/status-item/settings/power-and-positioning/bitmain-power-and-positioning',
  () => ({

...
import { MicroBTEditableThresholdForm } from '@/components/container-params-settings/micro-bt-editable-threshold-form'
import { MicroBTSettings } from '../settings/micro-bt-settings'
import * as utils from '@/components/explorer/containers/micro-bt/settings/micro-bt-utils'

vi.mock('@/components/container-params-settings', () => ({
  ContainerParamsSettings: vi.fn(() => <div data-testid="params" />),
}))

vi.mock('@/components/container-params-settings/micro-bt-editable-threshold-form', () => ({
...
vi.mock('@/components/explorer/containers/micro-bt/settings/micro-bt-utils', () => ({

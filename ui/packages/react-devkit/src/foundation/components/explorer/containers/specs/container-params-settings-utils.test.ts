...
import { getBitdeerParameterSettingsData } from '@/components/explorer/containers/bitdeer'
...
import { getMicroBTThresholdSettingsData } from '@/components/explorer/containers/micro-bt/settings/micro-bt-utils'
...
vi.mock('@/components/explorer/containers/bitdeer', () => ({

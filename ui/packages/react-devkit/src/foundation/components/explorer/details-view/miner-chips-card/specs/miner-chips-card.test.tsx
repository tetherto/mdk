...
import { MinerChip } from '@/components/explorer/details-view/miner-chips-card/miner-chip/miner-chip'
import { MinerChipsCard } from '../miner-chips-card'

vi.mock('@/components/explorer/details-view/miner-chips-card/miner-chip/miner-chip', () => ({

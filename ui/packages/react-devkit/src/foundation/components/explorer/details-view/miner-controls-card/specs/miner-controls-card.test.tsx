...
vi.mock('@/utils/use-notification', () => ({
...
vi.mock(
  '@/components/explorer/details-view/miner-setup-frequency-dropdown/miner-setup-frequency-dropdown',
  () => ({
...
vi.mock('@/components/explorer/dialogs', () => ({

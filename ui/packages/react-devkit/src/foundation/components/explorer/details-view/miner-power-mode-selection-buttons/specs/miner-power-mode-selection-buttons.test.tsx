...
import { getCurrentPowerModes } from '@/components/explorer/details-view/miner-controls-card/miner-controls-utils'
...
vi.mock(
  '@/components/explorer/details-view/miner-power-mode-selection-buttons/power-mode-selection-dropdown',
  () => ({

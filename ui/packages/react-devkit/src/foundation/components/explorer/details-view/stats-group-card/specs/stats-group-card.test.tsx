...
vi.mock('@/components/explorer/details-view/miner-metric-card/miner-metric-card', () => ({
...
vi.mock('@/components/explorer/details-view/single-stat-card/single-stat-card', () => ({
...
vi.mock('@/components/explorer/details-view/secondary-stat-card/secondary-stat-card', () => ({

...
import type { DataTableRowSelectionState } from '@core/index'
...
vi.mock('@/utils/use-list-view-filters', () => ({
...
vi.mock('@/components/pool-manager/miner-explorer/miner-explorer-utils', () => ({
...
vi.mock('@core/index', async (importOriginal) => {
  const original = await importOriginal<typeof import('@core/index')>()
  return {
    ...original,
...
vi.mock('@/components/pool-manager/miner-explorer/miner-explorer-toolbar', () => ({
...
vi.mock('@/components/pool-manager/miner-explorer/miner-explorer-table', () => ({
  MinerExplorerTable: ({
    data,
    loading,
  }: {

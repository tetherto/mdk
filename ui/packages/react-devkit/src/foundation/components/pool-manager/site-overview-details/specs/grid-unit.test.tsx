...
describe('GridUnit', () => {
  ...
  describe('mobileSelectionEnabled', () => {
    it('disables panning when mobileSelectionEnabled is true and alt is not held', () => {
      mockUseKeyDown.mockReturnValue(false)
    ...
    it('enables panning when mobileSelectionEnabled is false', () => {
      renderGridUnit({ mobileSelectionEnabled: false })
      const wrapper = screen.getByTestId('transform-wrapper')
      expect(wrapper.dataset.panningDisabled).toBe('false')
    })

    it('enables panning even when mobileSelectionEnabled is true if alt is held', () => {

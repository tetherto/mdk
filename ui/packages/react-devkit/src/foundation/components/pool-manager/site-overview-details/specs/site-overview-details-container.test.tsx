...
import { useSiteOverviewDetailsData } from '@/components/pool-manager/site-overview-details/use-site-overview-details-data'
...
} from '@/components/pool-manager/site-overview-details/site-overview-details-utils'
...
vi.mock('@/components/pool-manager/site-overview-details/use-site-overview-details-data', () => ({
...
vi.mock('@/components/pool-manager/site-overview-details/site-overview-details-utils', () => ({
...
vi.mock('@/components/pool-manager/site-overview-details/grid-unit', () => ({
  GridUnit: vi.fn(({ sectionKey }) => <div data-testid={`grid-unit-${sectionKey}`} />),
}))

vi.mock(
  '@/components/pool-manager/site-overview-details/site-overview-details-header/site-overview-details-header',
  () => ({
...
vi.mock(
  '@/components/pool-manager/site-overview-details/site-overview-details-legend/site-overview-details-legend',
  () => ({
    SiteOverviewDetailsLegend: vi.fn(() => <div data-testid="legend" />),
  }),
)

vi.mock('@/components/pool-manager/site-overview-details/miner-info-card/miner-info-card', () => ({
  MinerInfoCard: vi.fn(() => <div data-testid="miner-info-card" />),
}))

vi.mock(
  '@/components/pool-manager/sites-overview/set-pool-configuration/set-pool-configuration',
  () => ({
...
vi.mock(
  '@/components/pool-manager/sites-overview/set-pool-configuration/set-pool-configuration-modal',
  () => ({

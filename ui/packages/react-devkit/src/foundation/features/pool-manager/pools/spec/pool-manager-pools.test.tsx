...
import { usePoolConfigs } from '@/components'
...
vi.mock(
  '@/components/pool-manager/pools/pool-collapse-item-header/pool-collapse-item-header',
  () => ({
...
vi.mock('@/components/pool-manager/pools/pool-collapse-item-body/pool-collapse-item-body', () => ({
  PoolCollapseItemBody: ({ pool }: { pool: PoolSummary }) => (
    <div data-testid="pool-collapse-body" data-pool-name={pool.name} />
  ),
}))

vi.mock('@/components/pool-manager/pools/add-pool-modal/add-pool-modal', () => ({

import type { LogData } from '@core/index'
import { LogItem } from '@core/index'
...
vi.mock('@/utils/device-utils.ts', () => ({
  getDeviceData: vi.fn(),
  getMinerShortCode: vi.fn((code) => `short-${code}`),
}))

vi.mock('@/utils/container-utils.ts', () => ({
  getContainerName: vi.fn((container) => container ?? 'unknown'),
}))

vi.mock('@/utils/query-utils.ts', () => ({

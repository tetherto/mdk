...
/**
 * Inline alert banner with type-based icon, optional description, dismissible
 * close button, and trailing action slot.
 *
 * @category feedback
 *
 * @example
 * ```tsx
 * <Alert type="warning" title="Connection lost" showIcon closable />
 * ```
 * @domain generic
 * @tier agent-ready
 */

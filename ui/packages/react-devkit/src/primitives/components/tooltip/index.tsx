...
/**
 * One-line convenience wrapper around the full `<Tooltip>` primitive set.
 * Pass `content` (the hover text) and any single React element as `children`
 * — `<SimpleTooltip>` handles the provider, trigger, portal and content for
 * you. Prefer this over composing `<Tooltip>` + `<TooltipTrigger>` +
 * `<TooltipContent>` unless you need custom positioning or async content.
 *
 * @category overlays
 * @domain generic
 * @tier agent-ready

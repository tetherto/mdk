 ...
 *
 * Mirrors Mining OS's alerts data path: current alerts come from `list-things`
...
/** Upper bound on devices fetched for the current-alerts table (matches Mining OS). */
 ...
 * way Mining OS does — `$or` over `last.alerts ≠ null`, alert names, and the
